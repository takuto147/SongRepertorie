...
| サインイン画面。<br>"USER ID"にはメールアドレス、"ACCESS CODE"にはパスワードを入力。<br>("CREATE NEW ACCOUNT"以下は特に機能なし。) | 登録済みの曲の一覧を表示し、タグ・キー・スコアなどを確認できる。<br>フィルター/ソート/検索機能で欲しい曲データのみを表示させることが可能。　|
